<template>
  <div>
       ...
       <div class="form-element mt-6">
        ...
        <div class="form-element mt-6">
          <label for="" class="mb-2 ml-1 font-medium block">What is your favorite brand and why?</label>
          <textarea type="text" class="form-input" v-model="form.favorite" rows="5"></textarea>
        </div>
        ...
        <div class="form-element mt-6">
          ...
          <div>
            ...
            <div class="form-input space-x-3">
                <label for="selectResume" class="cursor-pointer hover:bg-gray-300 px-5 py-3 rounded">
    ...
    submitForm (response) {
      ...
      let config = {
        ...
        this.$axios.$post(`https://drupal.icon-ad.com/webform_rest/submit/?_format=json`, {
              webform_id: "join_the_team_junior_branding_gr",
              name: this.form.name,
              email: this.form.email,
              phone: this.form.phone,
              subject: this.form.subject,
              message: this.form.message,
              perfect: this.form.perfect,
